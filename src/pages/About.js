    ...
    return (
        <Container>
            <Jumbotron>
                ...
                <Row>
                    <Col size="md-12">
                        <h4 className="contactInfo">Rachel Kroetch | (408)613-9497 | rkroetch8@gmail.com</h4>
                    </Col>
                </Row>   
                <Row>
                    <Col size="xs-6" className="float-left">
                        <img src="../../public/assets/profilePic.jpeg" className="card-img float-left" alt="teal shirt"></img>
